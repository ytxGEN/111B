    ...
    public static int analyzePhrase(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (str.charAt(i) == ' ') {
                ...
                currentWordLength = i - firstCharIndex;                
                
                if (currentWordLength > longestWordLength) {
                    longestWordLength = currentWordLength;
                    longestWord = str.substring(firstCharIndex, i);
                }
            ...
            if (i == str.length() - 1) {
                ...
                wordCount++;
                currentWordLength = (i + 1) - firstCharIndex;

                if (currentWordLength > longestWordLength) {
                    longestWordLength = currentWordLength;
                    longestWord = str.substring(firstCharIndex, i + 1);
                }
